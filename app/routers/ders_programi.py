...
def update_ders_programi_endpoint(id: int, dp: DersProgramiUpdate, db: Session = Depends(get_db)):
...
@router.delete("/{id}")
def delete_ders_programi_endpoint(id: int, db: Session = Depends(get_db)):
